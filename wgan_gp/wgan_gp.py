...
class RandomWeightedAverage(_Merge):
    ...
    def _merge_function(self, inputs):
        alpha = K.random_uniform((64, 1, 1, 1))  # 64和 batchsize 有关
...
class WGANGP():
    ...
    def train(self, epochs, batch_size, sample_interval=50):
        ...
        # G_class = 'Coral_64'
        G_class='Jellyfish_64'
        # G_class='Zebrafish_64'
        # G_class='SeaAnemone_64'    #1000
        # G_class = 'Parrotfish_64'    #1500
        ...
        if os.path.exists(dis_weight) and os.path.exists(gen_weight):
            self.critic.load_weights(dis_weight)
        ...
        for epoch in range(epochs):
            ...
            if epoch % 100 == 0:
                ...
                self.critic.save_weights(dis_weight)
...
if __name__ == '__main__':
    wgan = WGANGP()
    wgan.train(epochs=1001, batch_size=64, sample_interval=30)
